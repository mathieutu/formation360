        ...
        <div class="bg-white shadow-md rounded my-6">
          <table class="min-w-max w-full table-auto">
            ...
            <tbody class="text-gray-600 text-sm font-light">
              <tr v-for="(user) in users" :key="user.id" class="odd:bg-gray-50 border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-3 px-6 text-left">
                  <div class="flex items-center">
                    <div class="mr-2">
                      <img class="w-6 h-6 rounded-full" :src="user.avatar">
                    </div>
                    <span>{{ user.name }}</span>
                  </div>
                </td>
                ...
                <td class="py-3 px-6 text-center">
                  <div class="flex item-center justify-center">
                    <nuxt-link :to="user.id" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
